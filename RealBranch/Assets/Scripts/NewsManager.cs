...
public class NewsManager : MonoBehaviour
{
    ...
    private int CountTotalRecordInDB()
    {
        ...
        using (dbconn = new SqliteConnection(dbURL))
        {
            ...
            dbCommand.CommandText = "Select COUNT(*) Total from News;";
    ...
    private void LoadItemFromDBIntoList()
    {
        using (dbconn = new SqliteConnection(dbURL))
        {
            ...
            dbQuery.CommandText = "Select * from News;";
    ...
    {
        Item chair = new Item(1, "AloeVera", 30.00f, "https://www.trademe.co.nz/business-farming-industry/office-furniture/desk-chairs/listing-2356237609.htm?rsqid=3512401f2c8a4cffad08f4acf7c7ab30-001", "Adjustable seat height Height adjustable back/lumbar\n Independently adjustable seat tilt - free floating or lockable");
    ...
    private void AddDemoDataToDB()
    {
        using (dbconn = new SqliteConnection(dbURL))
        {
            ...
            foreach (Item item in itemList)
            {
                ...
                string insertRecord = string.Format("INSERT into News (ID, Name, price, url, desc, categories, brands, designer, spec, noClick)" +
